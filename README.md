...
FILE
Can set preference to save commands output in output folder. It save output in <target username>_<command>.txt file. With FILE=y you can enable saving in file. With FILE=y you can disable saving in file.
...
##### Program features #####
----------------------
- 📌 Are you a professional reverse engineer?
- 📌 Are you a social media analyst?
- 📌 Are you looking for marketing?
- 📌 Are you looking to collect a follow page list for a particular page?
- 📌 Are you looking to collect a specific page following list?
- 📌 Are you looking for a biography of one page or several pages
- 📌 And all the other features can be seen in the demo movie. 
...
- 🔞 See Training 🎥 https://www.youtube.com/watch?v=uzDjdenzdTE&feature=youtu.be  🎥
